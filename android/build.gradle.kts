...
dependencies {
    // The whole monitor — protocol, engine, alarm, DSP — and its tests. This module is only the
    // Android shell over it: MediaCodec, AudioTrack, a foreground service and Compose.
    ...
    tasks.register(name) {
        ...
        doLast {
            val apk = layout.buildDirectory
                .file("outputs/apk/debug/android-debug.apk").get().asFile.absolutePath
            providers.exec {
