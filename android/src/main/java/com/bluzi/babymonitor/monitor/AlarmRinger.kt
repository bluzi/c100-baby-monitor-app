...
/**
 * Android's [Ringer]. ALRM-4 / ALRM-11 / ALRM-14 / WATCH-3: rings the alarm — on the ALARM audio
 * stream, so it cuts through a muted feed and media volume — until acknowledged from the app or
 * the notification. Each alarm kind has its own sound, volume and vibrate setting, so a parent
 * knows what happened by ear before they can read the screen.
 *
