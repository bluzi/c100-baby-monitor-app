...
/**
 * Android's [AudioOutput]: Opus → MediaCodec → AudioTrack, with an analysis tap. Mute only
 * silences the speaker (LIVE-3): decoding and the analysis callback keep running so the level
 * meter and alarm stay live.
 */
