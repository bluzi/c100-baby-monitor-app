...
/**
 * Dresses the shared decision (core's [viewerActionKinds] — BG-11/WATCH-11) in Android's icons.
 * WHICH controls exist is the spec's business and is decided in core, so the phone's button row
 * and the Mac's tray menu cannot drift apart; what they LOOK like is this file's business.
 */
fun viewerActions(
    muted: Boolean,
    running: Boolean,
