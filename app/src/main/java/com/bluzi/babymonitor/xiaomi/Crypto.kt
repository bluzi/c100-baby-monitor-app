...
object Crypto {
    ...
    fun passwordHash(password: String): String =
        md5(password.toByteArray()).toHex().uppercase()
    ...
    fun calcSharedKey(devicePublicHex: String, clientPrivateHex: String): ByteArray {
        ...
        val mult = ByteArray(32)
        X25519.scalarMult(priv, 0, pub, 0, mult, 0)
        return hsalsa20(mult)
    }
    ...
    fun genNonce(nowMs: Long = System.currentTimeMillis(), random8: ByteArray = randomBytes(8)): ByteArray {
    ...
    fun genSignatureB64(method: String, path: String, data: String, rc4Hash: String?, signedNonce: ByteArray): String {
        ...
        return sha1(s.toByteArray()).toBase64()
    }
}
